...
class StartServices extends Command
{
    ...
    protected function startFaceService(string $projectRoot): void
    {
        ...
        $faceServicePath = $projectRoot . DIRECTORY_SEPARATOR . 'Agent' . DIRECTORY_SEPARATOR . 'python-face-service';
    ...
    protected function startFireService(string $projectRoot): void
    {
        ...
        $fireServicePath = $projectRoot . DIRECTORY_SEPARATOR . 'Agent' . DIRECTORY_SEPARATOR . 'fire-detection-service';
